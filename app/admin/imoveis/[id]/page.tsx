...
export default function EditImovelPage() {
      ...
      .then(listing => {
        if (listing && !listing.error) {
          ...
          setFormData({
            ...
            type: listing.type || 'T2',
            bedrooms: String(listing.bedrooms || '2'),
            ...
            energyClass: listing.energyClass || 'C',
            features,
            images,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/imoveis?id=${id}`, {
        method: 'PUT',
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-[#0A2240]">Editar Imóvel</h1>
      </div>
